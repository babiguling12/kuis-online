 ...
 * @author TUF GAMING
 */
public class BuatKuis extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        simpankuis.setText("Buat Pertanyaan");
        ...
        jPanel9.add(reset, java.awt.BorderLayout.LINE_START);
    ...
    private void simpankuisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpankuisActionPerformed
        ...
        if (kuis == null) {
            jumlahSoal = (int) Input_JumlahSoal.getValue();
            ...
            for (int i = 1; i <= jumlahSoal; i++) {
                ...
                daftarPertanyaan.add(pertanyaan); // Tambahkan ke daftar
            }

            // Menyetelekan daftar pertanyaan ke dalam kuis
            kuis.setPertanyaan(daftarPertanyaan);
            ...
            // Simpan Pertanyaan
            try {
                PertanyaanDAO.addListPertanyan(kuis.getPertanyaan());
            } catch (SQLException ex) {
                Logger.getLogger(BuatKuis.class.getName()).log(Level.SEVERE, null, ex);
            }
