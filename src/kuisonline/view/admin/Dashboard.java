...
public class Dashboard extends javax.swing.JPanel {
     ...
     */
    public Dashboard(DashboardAdmin mainFrame) {
    ...
    void setMapelComboBox() {
        try {
            for (Kategori k : KategoriDAO.getAllKategori()) {
                pilihmapel.addItem(k.getNamaKategori());
            }
    ...
    private void initComponents() {
        ...
        pilihmapel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua Mata Pelajaran" }));
    ...
    private void pilihmapelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihmapelActionPerformed
        this.idKategori = pilihmapel.getSelectedIndex();
        refreshKuisPanel();
    ...
    private javax.swing.JComboBox<String> pilihmapel;
